...
"""This implements http server using magichttp."""
...
class MagichttpServerProtocol(magichttp.HttpServerProtocol):
    ...
    def connection_made(  # type: ignore
        ...
        self._keep_reading = self._loop.create_task(self._read_forever())
...
class MagicHttpResponse(responses.WritableResponse):
    def __init__(
        self,
        __writer: magichttp.HttpResponseWriter,
        __request: MagicHttpRequest,
    ) -> None:
